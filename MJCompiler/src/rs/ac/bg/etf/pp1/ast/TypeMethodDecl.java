...
public class TypeMethodDecl extends MethodDecl {
    ...
    public TypeMethodDecl (TypeMethod TypeMethod, MethodFormPars MethodFormPars, MethodVarDecl MethodVarDecl, MethodDummy MethodDummy, StatementList StatementList) {
